...
SEED_MILE = {
    "chong": [
        {"name": "EKC 한-유럽 특별세션", "date": "2026-07-15", "cat": "국제협력", "note": "에너지/기계 분과"},
        {"name": "국제공동워크숍(KIMM 개최)", "date": "2026-08-05", "cat": "국제협력", "note": "DLR 참석"},
        {"name": "운영위원회", "date": "2026-09-15", "cat": "운영·관리", "note": "연 1회 이상"},
        {"name": "수요기업 사업화 설명회", "date": "2026-10-20", "cat": "성과관리", "note": "국내 수요기업"},
        {"name": "DLR 기술교류·방문(독일)", "date": "2026-11-10", "cat": "국제협력", "note": "한·독 교류"},
